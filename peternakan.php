...
$query = "SELECT * FROM DataInokulasi WHERE kategori = 'Peternakan'";
...
<body>
  ...
  <h1>Data Inokulasi - Peternakan</h1>
  ...
  <?php endwhile; ?>
    ...
    <button onclick="location.href='tambahbakteri.php?kategori=Peternakan'" style="background:#FFA347; color:black; padding:10px 20px; border:none; border-radius:5px;">
    ➕
    </button>
    </div>
