...
$query = "SELECT * FROM DataInokulasi WHERE kategori = 'Perikanan'";
...
<head>
  <meta charset="UTF-8">
  <title>Perikanan - BacterFly</title>
...
<body>
  ...
  <h1>Data Inokulasi - Perikanan</h1>
  ...
  <div style="text-align: center; margin: 10px;">
    <button onclick="location.href='tambahbakteri.php?kategori=Perikanan'" style="background:#FFA347; color:black; padding:10px 20px; border:none; border-radius:5px;">
    ➕
    </button>
    </div>
</body>
